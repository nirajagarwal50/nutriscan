...
const TARGET = Math.min(600, Math.max(50, Number(process.env.SEED_TARGET_COUNT || 500)))
...
const SEARCH_TERMS = [
  'Lays', 'Kurkure', 'Bingo', 'Uncle Chipps', 'Doritos', 'Pringles',
  'Too Yumm', 'Yellow Diamond', 'Balaji Wafers', 'TagZ', 'Haldirams', 'Bikaji',
  'Bikano', 'Balaji Namkeen', 'Prakash Namkeen', 'Chitale Bandhu',
  'Garden Namkeens', 'Laxmi Snacks', 'Avadh Snacks', 'Mukharochak',
  'Parle G', 'Britannia Good Day', 'Marie Gold', 'Hide and Seek',
  'Little Hearts', 'Oreo', 'Treat Croissant', 'Dark Fantasy', 'Milk Bikis',
  'Cadbury Dairy Milk', 'KitKat', 'Perk', '5 Star', 'Munch', 'Snickers',
  'Ferrero Rocher', 'Toblerone', 'Pulse Candy', 'Alpenliebe',
  'Coca Cola', 'Pepsi', 'Thums Up', 'Sprite', 'Frooti', 'Maaza',
  'Real Juice', 'Paper Boat', 'Red Bull', 'Gatorade',
  'Yoga Bar', 'The Whole Truth', 'RiteBite Max Protein', 'Eat Better Co',
  'Slurrp Farm', 'Open Secret', 'True Elements', 'Farmley',
  'Nutty Gritties', 'Snackible',
  'Maggi', 'Yippee', 'Top Ramen', 'MTR Ready Meals', 'Gits',
  'Haldirams Ready Meals', 'Kitchens of India', 'Ashirvaad Ready Meals',
  'Chings Secret', 'Knorr Soup',
  'Amul Ice Cream', 'Kwality Walls', 'Vadilal Ice Cream',
  'Mother Dairy Ice Cream', 'Havmor Ice Cream',
  'Kelloggs Cornflakes', 'Quaker Oats', 'Saffola Oats',
  'Tata Soulfull Millet Muesli', 'Bagrrys Muesli', 'Patanjali Daliya',
  'Aashirvaad Atta', 'Bournvita', 'Horlicks', 'Boost', 'Complan',
  'Tang', 'Rasna', 'Bru Coffee', 'Nescafe', 'Tata Tea', 'Red Label Tea',
  'Taj Mahal Tea', 'Society Tea', 'Wagh Bakri Tea',
  'Paper Boat Aam Panna', 'Paper Boat Jaljeera', 'Real Mixed Fruit Juice',
  'Tropicana Juice', 'Minute Maid', 'Slice Mango Drink', 'Appy Fizz',
  '7UP', 'Mirinda', 'Mountain Dew',
  'Lay\'s Cream & Onion', 'Lay\'s Magic Masala', 'Kurkure Masala Munch',
  'Kurkure Green Chutney', 'Bingo Mad Angles', 'Bingo Tedhe Medhe',
  'Too Yumm Multigrain Chips', 'Haldirams Aloo Bhujia', 'Haldirams Bhujia Sev',
  'Bikaji Bikaneri Bhujia', 'Bikano Navratan Mix', 'Balaji Ratlami Sev',
]
